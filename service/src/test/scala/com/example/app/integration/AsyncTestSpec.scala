...
/**
 * This test sends a single predict request event to Kafka and verifies that
 * the single prediction event has been generated with the right price
 */
class AsyncTestSpec extends FlatSpec with ForAllTestContainer with Matchers {
